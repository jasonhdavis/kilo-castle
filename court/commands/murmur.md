---
description: Aggregate Serf humble opinions to surface bottom-up field recommendations on project direction and optimizations
agent: steward
---
Arguments: $ARGUMENTS

Follow the Murmur Protocol:
1. Run `court rollup --section opinion $ARGUMENTS` to extract all Humble Opinion sections.
